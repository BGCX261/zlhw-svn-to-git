...
{   
    ...
    private        PatternUtils()   
     ...
     public static final String custom_file_type="^(/{0,1}(\\S|\\s)){1,}\\.(%1$s)$|^(\\S|\\s){1,}\\.(%1$s)$";
     /**
      * 匹配email地址
      *
      * 格式: XXX@XXX.XXX.XX
      ...
      * 匹配中括号 表达式
      */
     public static final String  middle_bracket_regex="\\[|\\]";
      ...
      *
      */  
     public static final String chinese_word = "[\u4e00-\u9fa5]+";
