...
public class DwgToBitmap {
	...
	//--- Bitmap raw data
	private int bitmap []; 
	public DwgToBitmap(String filePath,String oFilePath,int width,int height){
	...
	public static void main(String[] args) {
		DwgToBitmap test=new DwgToBitmap("D:/tomcat-6.0/webapps/JNLXC/map/f的分工.dwg","1.bmp",500,500);
